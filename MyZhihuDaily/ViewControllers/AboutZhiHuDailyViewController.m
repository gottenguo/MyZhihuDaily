...
-(void)setCententView{
    ...
    iconImageView.frame = CGRectMake((self.view.frame.size.width-iconImage.size.width)/2-10, 70, 80, 80);
    iconImageView.image = iconImage;
    iconImageView.layer.masksToBounds =YES;
    iconImageView.layer.cornerRadius =20;
    
    UIImageView *downloadImageView = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"QR_Code"]];
    downloadImageView.frame = CGRectMake(iconImageView.frame.origin.x+120, 70, 80, 80);
    
    UILabel *label = [[UILabel alloc]init];
    label.numberOfLines = 0;
    label.lineBreakMode = NSLineBreakByCharWrapping;
    label.text = ZhiHuDailySummary;
    label.frame = CGRectMake(20, iconImageView.frame.origin.y+110, self.view.frame.size.width-30, 200);
    ...
    bottomView.frame = CGRectMake((self.view.frame.size.width-bottomiImage.size.width)/2, self.view.frame.size.height-135, 139, 43);
