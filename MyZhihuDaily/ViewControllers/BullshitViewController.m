...
- (instancetype)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil{
    ...
    if(self){
        ...
        UIImage *deselectedImage = [UIImage imageNamed:@"Tabbar_Feed_Normal"];
        UIImage *selectedImage = [UIImage imageNamed:@"Tabbar_Feed_Highlight"];
        
        UITabBarItem *tabBarItem = [[UITabBarItem alloc]initWithTitle:@"瞎扯" image:nil tag:0];
